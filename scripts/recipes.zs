...
recipes.removeShaped(<projecte:item.pe_dm_armor_0>, [[null, null, null],[<projecte:item.pe_matter>, null, <projecte:item.pe_matter>], [<projecte:item.pe_matter>, null, <projecte:item.pe_matter>]]);

recipes.removeShaped(<projecte:item.pe_dm_armor_3>, [[null, null, null],[<projecte:item.pe_matter>, <projecte:item.pe_matter>, <projecte:item.pe_matter>], [<projecte:item.pe_matter>, null, <projecte:item.pe_matter>]]);
